...
$('#contact-form-2-form').submit(function () {
    ...
    if ($(this).valid()) {
		...
		window.open('https://api.whatsapp.com/send?phone=554520312791&text=Ol%C3%A1,%20encontrei%20seu%20contato%20no%20site%20https://cadastro.luciluci.digital.%20Quero%20trabalhar%20com%20a%20Luci%20Luci','_self');
	},
            error: function () {
	}
        });
